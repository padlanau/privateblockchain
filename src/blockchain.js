...
class Blockchain {
    ...
    submitStar(address, message, signature, star) {
        let self = this;
        return new Promise(async(resolve, reject) => {
            let messageSigningTime  = parseInt(message.split(':')[1]);
            let currentTime = parseInt(new Date().getTime().toString().slice(0, -3));
            let timeDifference = currentTime - messageSigningTime; 

            console.log("timeDifference " + timeDifference);
            console.log("currentTime  " + currentTime);
            console.log("messageSigningTime " + messageSigningTime);
             ...
             if (timeDifference <= 300) {
                 ...
                 if (validSig) {
                     ...
                     console.log("Star has been successfully submitted and added to the blockchain!")
                     resolve(newBlock);
                 } else {
                 ...
                 console.log("Timeout")
                 reject("Timeout. New Star can only be added within 5 minutes....");
             }
        });
    }
